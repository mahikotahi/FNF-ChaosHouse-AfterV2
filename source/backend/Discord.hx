...
class DiscordClient
{
	...
	private static final _defaultID:String = "1209148571295813662";
	...
	public static function changePresence(?details:String = 'Desktop', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
